const tecnologias = ["planejamento", "organização", "produtividade", "cronograma", "disciplina", "foco", "metas", "objetivos", "concentração", "estratégia", "rotina", "calendário", "horário", "revisão", "agenda", "priorização", "motivação", "desempenho", "checklist", "anotações", "dedicação", "execução", "progresso", "constância", "eficiência", "persistência", "autodisciplina", "planejamento", "metas", "foco"
];
